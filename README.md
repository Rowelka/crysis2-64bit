...
| `-nomodfix` | leave the other modules' copies of the allocator truncating, as the game ships them |
...
| `-nomodfix` | leave the truncating stores in every module's copy of the allocator alone |
